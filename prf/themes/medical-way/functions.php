...
function medical_way_scripts() {
	...
	wp_enqueue_script( 'medical-way-custom', get_template_directory_uri() . '/assets/js/custom.js', array( 'jquery' ), '1.1.6', true );
...
function medical_way_admin_scripts( $hook ) {
	...
	if( 'widgets.php' === $hook ){
		...
		wp_enqueue_style( 'medical-way-admin', get_template_directory_uri() . '/includes/widgets/css/admin.css', array(), '1.1.6' );

		wp_enqueue_media();

		wp_enqueue_script( 'medical-way-admin', get_template_directory_uri() . '/includes/widgets/js/admin.js', array( 'jquery' ), '1.1.6' );
