						...
						<div class="welcome-section-wrapper is_loading">
							...
							<div class="notice-sidebar is_loading">
								<div class= "notice-sidebar-item">
									...
									<p><a href="<?php echo esc_url('https://www.facebook.com/8DegreeThemes');?>" target="_blank"><?php echo esc_html('Join our Facebook Group','eightmedi-lite') ?></a> <?php echo esc_html('- to receive updates, offers and more.','eightmedi-lite') ?></p>
									<p><a href="<?php echo esc_url('https://www.youtube.com/8degreethemes');?>" target="_blank"><?php echo esc_html('Subscribe our YouTube Channel','eightmedi-lite') ?></a> <?php echo esc_html('- for tutorials, videos and more.','eightmedi-lite') ?></p>
									<p><a href="<?php echo esc_url('https://www.twitter.com/8degreethemes');?>" target="_blank"><?php echo esc_html('Follow us on Twitter','eightmedi-lite') ?></a> <?php echo esc_html('- to stay updated.','eightmedi-lite') ?></p>
								</div>
								<div class= "notice-sidebar-item">
									...
									<a href="<?php echo esc_url('https://wordpress.org/support/theme/eightmedi-lite/');?>" target="_blank"><?php echo esc_html('Submit a review','eightmedi-lite') ?></a>
